 ...
 * @author AntonyCheng
 */
@WebFilter(filterName = "ResourceCensorApiFilter", urlPatterns = "/*")
@Slf4j
public class ResourceCensorApiFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        String needHandleRequest = "/api/resource_censor/**";
