...
public class TeacherController {
    ...
    @ApiOperation("用户登录接口")
    @Transactional(rollbackFor = CustomizeTransactionException.class)
    public R<String> login(@ApiParam(name = "teacherRegisterVo", value = "教师登录VO实体", required = true) @RequestBody TeacherLoginVo teacherLoginVo, HttpServletRequest request) {
        // 判空
        ...
        // 先进行数据的清空
        Object attribute = request.getSession().getAttribute(CommonConstant.USER_LOGIN_STATE);
        if (attribute != null) {
